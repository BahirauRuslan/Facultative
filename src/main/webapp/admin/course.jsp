...
<form method="post" style="margin-top: 20px; margin-left: 30vw; width: 40vw">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="fullName" name="name" placeholder="Enter course name" value=<%=((Course)request.getAttribute("course")).getName()%>>
    </div>
    <div class="form-group">
        <label for="exampleFormControlTextarea1">Course description</label>
        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3"><%=((Course)request.getAttribute("course")).getDescription()%></textarea>
    </div>
    <div class="form-group">
        <label for="exampleFormControlSelect1">Select new teacher</label>
    ...
    <button type="submit" name="deleteCourse" class="btn btn-primary">Delete course</button>
</form>
