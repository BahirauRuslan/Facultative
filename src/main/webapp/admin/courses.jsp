...
<a name="" id="" class="btn btn-primary" href="/Facultative/admin/courseadd" role="button">Добавить курс</a>

<div class="list-group">
    <%
        List<Course> courses =  (List<Course>)request.getAttribute("courses");
        for (Course course : courses) { %>
    <a href="/Facultative/admin/course?id=<%=course.getId()%>" class="list-group-item list-group-item-action">
        <%=course.getName() + " - Teacher login:" + course.getTeacher().getLogin()%></a>
    <%}%>
</div>
